...
function Content() {
  return (
    <div>
      <section className="bg-[#F5F8FF]">
        <div className="pt-5 px-10 xl:px-20 xl:flex xl:justify-between">
          <div className='space-y-7 mt-5'>
            ...
            <h2 className="max-w-sm text-lg sm:text-xl font-semibold text-gray-500">Upbox is the easiest way to look your best without having to hunt for the perfect makeup combination. Our stylists curate the latest trends and send them directly to your door every month.</h2>
      ...
      <p className="px-7 md:text-center text-lg sm:text-xl mb-20 font-semibold text-gray-500">Your plan auto-renews at the end of 30 days from the 1st day you signed-up.</p>
